...
<div id="content" style="margin-left:240px;"> 
    ...
    <h1>Danh sách nhân viên bếp ăn</h1>
    <nav>
      <ol class="breadcrumb">

        <li class="breadcrumb-item">Nhân viên bếp ăn</li>
                ...
                if (!empty($dsNVbep)) {
                  foreach ($dsNVbep as $item) { ?>
                    <tr>
                      ...
                      <td><button class="btn btn-secondary"><a style="color: #fff;" href="admin.php?mod=DeleteUser&po=NVBep&idtaikhoan=<?php echo $item['idtaikhoan'] ?>" onclick="return confirm('Bạn chắc chắn muốn xóa chứ!')">Xóa</a></button>
